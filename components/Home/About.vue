<template>
  <div
    class="flex flex-wrap py-20 bg-no-repeat about_bg"
    style="
    ...
    "
  >
    <div class="md:!w-[50%] w-[100%] flex justify-center">
      <img
        src="/about.png"
        alt="About Langua"
    ...
    <div class="md:!w-[50%] w-[100%] mx-10 md:mx-0">
      ...
      <p class="text-[16px] font-[400] text-[#202020] md:w-[75%]">
        {{ $t("S2.desc") }}
      </p>
